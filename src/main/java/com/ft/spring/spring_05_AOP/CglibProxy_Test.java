...
@ContextConfiguration(locations = {"classpath:applicationContext_05_AOP_CglibProxy.xml"})
public class CglibProxy_Test {
    ...
    @Test
    public void test(){
        log.info("---------- 执行 {} ----------", cglibProxyBean1.getClass());
        cglibProxyBean1.exe_a();

        log.info("---------- 执行 {} ----------", cglibProxyBean2.getClass());
        cglibProxyBean2.exe_a();
    }
}
